...
plaNETic.compute_posterior(comp_option_mass, comp_option_radius, SiMgFe_ratio_option, water_mixing_option, luminosity_option, use_log_prior_for_gas_mass, with_gas, with_water, csv_file, comment, verbose=False, save_prior=True, date_string=date_string)
